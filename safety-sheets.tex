...
Make sure you know where the emergency stops and fire extinguishers are.
}{
...
If something breaks or is amiss -- it is \textbf{your} responsibility to report it. 

If you find something broken -- report it before using/repairing the machine.
}
...
There should \textbf{never be more than a 125 liters} of `water equivalent' volume present at the space (aggregated across all cylinders, empty or full, pressured or unpressured).
