...
\begin{center}
	...
	\action{49}{\textbf{%
 		\IfSubStr{#2}{Approval}%
			...
			{\IfSubStr{#2}{NoMandatory}{Mandatory Instructions}{Instructions Mandatory}}%
		}}
		{%
		\IfSubStr{#2}{NoMandatory}{}{Instructions \textbf{prior} to use are mandatory. Check the wiki for whom can help you.}
